...
The list of supported mnemonics is:
  ...
  ADDx, ANDx, CALL, CBW, CMPx, CMPSB, CWDE, DECB, DECL, DIVx, IDIVx, IMULx,
  INCx, INT, Jcc, LEA, MOVx, MOVSB, MULx, NEGx, NOP, ORx, POP, POPF, PUSH,
  PUSHF, REP, REPE, REPNE, RET, SALx, SARx, SCASB, SHLx, SHRx, SUBx, XORx.
