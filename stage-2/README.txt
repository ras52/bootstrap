...
together with the negative 'Ncc' versions [except for PE and PO]).  Some
...
program counter relative 32-bit immediate; the unary arithmetics, INCx,
DECx, NEGx, NOTx, SALx, SHLx, SARx, SHRx, MULx, IMULx, DIVx and IDIVx,
take a single 8- or 32-bit r/m operand (matching the regmem production),
and PUSH and POP take a 32-bit r/m.  LEA takes a 32-bit r/m followed by
a 32-bit register; the binary arithmetics, MOVx, ADDx, SUBx, ADCx, SBBx,
CMPx, ANDx, ORx, XORx take either a r/m and a register (in either order)
